...
class QuizInterface():
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(self.window, image=self.true_image, highlightthickness=0, command=self.true_pressed)
        self.true_button.grid(row=2, column=0)
        self.false_button = Button(self.window, image=self.false_image, highlightthickness=0, command=self.false_pressed)
